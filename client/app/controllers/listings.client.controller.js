  ...
  function($scope, $location, $stateParams, $state, Listings){
    ...
    $scope.find = function() {
      ...
      Listings.getAll().then(function(response) {
        ...
        response.data.forEach(function(listings){
          var listing = {
           "name" : listings.name,
           "code" : listings.code,
         ...
         if(listings.coordinates){
           listing.latitude = listings.coordinates.latitude;
           listing.longitude = listings.coordinates.longitude;
         }

         listing["id"] = listings.code;

          $scope.mapMarkers.push(listing);
        });
